      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AiProductBlock
            ...
            intro="上传合同，乔曦直接告诉你'签/改/拖/退'：国内唯一把决策写进答案的合同审查产品。"
            features={[
            ...
            differentiator="市面上所有合同审查产品只输出'风险清单'或'法律意见'，把最终决策留给你。乔曦直接输出商业决策：签/改/拖/退四选一，每个选项附具体理由和操作指引。"
          ...
          <AiProductBlock
            ...
            intro="陈曦就是为这种窘境设计的。与前三个产品不同，陈曦内核是智能Agent：锁定文种、结构铁律、四角色评审（党办/政研/纪检/基层），确保公文合规不踩雷。22种法定公文全覆盖，GB/T 9704国标排版，连格式都替你搞定。你只需要说清楚要写什么，剩下的交给陈曦。"
            features={[
              '22种法定公文+7种常见正式材料全覆盖',
            ...
            differentiator="市面上公文产品靠范文库堆量。陈曦靠结构铁律和评审机制：不建范文库，靠文种DNA和四角色评审确保质量。你不需要有范文，只需要说清楚要写什么。"
